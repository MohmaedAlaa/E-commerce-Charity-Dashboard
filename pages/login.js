    ...
    <>
      <div className="min-h-screen flex w-full">
        ...
        <div className="relative flex-1 flex flex-col justify-center py-12 sm:px-6 lg:flex-none lg:px-12 xl:px-12 w-1/2">
          {/* <div className="absolute text-[#707082] font-medium top-24 left-[600px] w-24 ">
            <a href="#">
              ...
              <div className="mt-6">
                ...
                >
                  ...
                  <div className="text-sm">
                    <a href="/createAccountP1" className="font-medium">
                      Don't have an account?
                      <span className="ml-1 text-base"> Create Account</span>
                    </a>
                  </div>
                </form>
              </div>
