...
import Steps from "../components/Login/StepsP3";
import CreateAccountP3Uploder from "../components/CreateAccountP3Uploder";
  ...
  return (
    <>
      <div className="min-h-screen flex w-full">
        ...
        <div className="relative flex-1 flex justify-center py-20 sm:px-6 lg:flex-none lg:px-12 xl:px-12 w-1/2">
          <div className="mx-auto w-full ">
            <div style={{font:'normal normal medium 14px/17px Urbanist'}}>
              <a href="/createAccountP2" className="text-[#707082]"><ArrowBackIosNewOutlinedIcon className="w-3.5 h-3.5 mb-0.5"/> Back</a>
            </div>
            ...
            <div className='w-full flex justify-center'>
              <div>
                ...
                <div className='row flex text-[#CDCFDC] gap-5' style={{font:'normal normal medium 14px/17px Urbanist'}}>
                  <p className='text-[#232323]'>General Info</p>
                  <p className='text-[#232323]'>Charity Details</p>
                  <p className='text-[#3D897A]'>Logo</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-16">
              <div className="mt-6">
                ...
                >
                  <div>
                    <p className='mb-3 text-[#707082]' style={{font:'normal normal medium 14px/17px Urbanist'}}>Logo</p>
                    <CreateAccountP3Uploder/>
                  </div>
