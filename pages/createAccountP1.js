...
import Steps from "../components/Login/StepsP1";
  ...
  return (
    <>
      <div className="min-h-screen flex w-full">
        ...
        <div className="relative flex-1 flex justify-center py-12 sm:px-6 lg:flex-none lg:px-12 xl:px-12 w-1/2">
          <div className="mx-auto w-full">
            <div style={{font:'normal normal medium 14px/17px Urbanist'}}>
              <a href="/login" className="text-[#707082]"><ArrowBackIosNewOutlinedIcon className="w-3.5 h-3.5 mb-0.5"/> Back</a>
            </div>
            ...
            <div className='w-full flex justify-center'>
              <div>
                ...
                <div className='row flex text-[#CDCFDC] gap-6' style={{font:'normal normal medium 14px/17px Urbanist'}}>
                  <p className='text-[#3D897A]'>General Info</p>
                  <p>Charity Details</p>
                  <p>Logo</p>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="mt-1 relative">
                      <input
                        ...
                        className="appearance-none block w-full text-[#232323]border border-[#D4D4D4] rounded-[10px] py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-[#D4D4D4] focus:ring-[#3D897A]"
                      />
                      <button onClick={togglePassword} className='absolute top-2.5 right-3 text-[#707082]'>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <label
                        htmlFor="remember-me"
                        className="ml-2 block text-sm text-[#707082]"
                        style={{font:'normal normal normal 12px/17px Urbanist'}}
                      >
                        I agree to Mytreety's <spn className='text-[#232323]' style={{font:'normal normal 600 12px/17px Urbanist'}}> General terms and conditions </spn>
                         & 
                         <span className='text-[#232323]'   style={{font:'normal normal 600 12px/17px Urbanist'}}> Privacy policy  </span>
                         & 
                         <span className='text-[#232323]' style={{font:'normal normal 600 12px/17px Urbanist'}}> Charity policy </span>.
                      </label>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="text-sm mt-8 mb-16 ml-60">
